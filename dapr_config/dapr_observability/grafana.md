...
<img src="https://github.com/dapr/docs/blob/v1.1/images/grafana-system-service-dashboard.png" alt="Screenshot of the system service dashboard" width=1200>
...
<img src="https://github.com/dapr/docs/blob/v1.1/images/grafana-sidecar-dashboard.png" alt="Screenshot of the sidecar dashboard" width=1200>
...
<img src="https://github.com/dapr/docs/blob/v1.1/images/grafana-actor-dashboard.png" alt="Screenshot of the actor dashboard" width=1200>
...
1. Select `Configuration` and `Data Sources`
   ...
   <img src="https://github.com/dapr/docs/blob/v1.1/images/grafana-datasources.png" alt="Screenshot of the Grafana add Data Source menu" width=200>


1. Add Prometheus as a data source.

      <img src="https://github.com/dapr/docs/blob/v1.1/images/grafana-add-datasources.png" alt="Screenshot of the Prometheus add Data Source" width=600>
...
1. Fill in the following settings:
   ...
   <img src="https://github.com/dapr/docs/blob/v1.1/images/grafana-prometheus-dapr-server-url.png" alt="Screenshot of the Prometheus Data Source configuration" width=600>
...
1. In the upper left corner of the Grafana home screen, click the "+" option, then "Import".
   ...
   <img src="https://github.com/dapr/docs/blob/v1.1/images/grafana-uploadjson.png" alt="Screenshot of the Grafana dashboard upload option" width=700>

1. Find the dashboard that you imported and enjoy

   <img src="https://github.com/dapr/docs/blob/v1.1/images/system-service-dashboard.png" alt="Screenshot of Dapr service dashbaord" width=900>

   Hover your mouse over the `i` in the corner to the description of each chart:

   <img src="https://github.com/dapr/docs/blob/v1.1/images/grafana-tooltip.png" alt="Screenshot of the tooltip for graphs" width=700>
